...
class BaseCommands(commands.Cog):
    ...
    async def role_assign(self, interaction: discord.Interaction, role: discord.Role):
        ...
        # otherwise, carry on
            ...
            if role not in user.roles:
                ...
                return await interaction.response.send_message(f"You have been assigned the role: {role.name}.")
            # otherwise, remove the role
                ...
                return await interaction.response.send_message(f"You have been removed from the role: {role.name}.")
    ...
    async def edit_message(self, interaction: discord.Interaction, channel: discord.TextChannel, message: str, content: str):
        # defer interaction
